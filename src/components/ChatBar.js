...
const ChatBar = (props) => {
  const [state, setState] = React.useState([
    { id: 1, image: "/images/fawad1.jpg", name: "Beth" },
    { id: 2, image: "/images/fawad2.jpg", name: "Jerry" },
    ...
    { id: 6, image: "/images/imran3.jpg", name: "Random guy" },
    { id: 7, image: "/images/profile.jfif", name: "Aliens" },
    { id: 8, image: "/images/fawad1.jpg", name: "Vindicators" },
    { id: 9, image: "/images/fawad2.jpg", name: "King" },
